...
"[project]/app/components/appointments/AppointmentUpdateModel.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const AppointmentUpdateModal = ({ onClose, appointment = null })=>{
    ...
    // Fetch patients
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppointmentUpdateModal.useEffect": ()=>{
            const fetchPatients = {
                "AppointmentUpdateModal.useEffect.fetchPatients": async ()=>{
                    try {
                        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/patients");
                        if (res?.success && Array.isArray(res.data)) {
                            setPatients(res.data.map({
                                "AppointmentUpdateModal.useEffect.fetchPatients": (p)=>p.name
                            }["AppointmentUpdateModal.useEffect.fetchPatients"]));
                        }
                    } catch (err) {
                        console.error("Failed to fetch patients:", err);
                    }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppointmentUpdateModal.useEffect": ()=>{
            const fetchDoctors = {
                "AppointmentUpdateModal.useEffect.fetchDoctors": async ()=>{
                    try {
                        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/doctors");
                        if (res?.success && Array.isArray(res.data)) {
                            setDoctors(res.data.map({
                                "AppointmentUpdateModal.useEffect.fetchDoctors": (d)=>({
                                        name: d.name,
                                        fee: d.fee
                                    })
                            }["AppointmentUpdateModal.useEffect.fetchDoctors"]));
                        }
                    } catch (err) {
                        console.error("Failed to fetch doctors:", err);
                    }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppointmentUpdateModal.useEffect": ()=>{
            const selectedDoctor = doctors.find({
                "AppointmentUpdateModal.useEffect.selectedDoctor": (d)=>d.name === doctor
            }["AppointmentUpdateModal.useEffect.selectedDoctor"]);
            if (selectedDoctor) {
                setFee(selectedDoctor.fee);
            } else {
                setFee("");
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            setLoading(true);
            if (appointment?._id) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/appointments/updateAppointment/${appointment._id}`, {
                    method: "PUT",
...
_s(AppointmentUpdateModal, "o6b8jJseLDmkHv1u42Klfme3f1s=");
_c = AppointmentUpdateModal;
const __TURBOPACK__default__export__ = AppointmentUpdateModal;
var _c;
__turbopack_context__.k.register(_c, "AppointmentUpdateModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$appointments$2f$AppointmentUpdateModel$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/appointments/AppointmentUpdateModel.jsx [app-client] (ecmascript)"); // fixed typo
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
const AppointmentsPage = ()=>{
    ...
    /* ---------------- CREATE APPOINTMENT ---------------- */ const handleCreate = async (newAppointment)=>{
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/appointments/createAppointment", {
                method: "POST",
                data: newAppointment
            });
    ...
    /* ---------------- UPDATE APPOINTMENT ---------------- */ const handleUpdate = async (updatedAppointment)=>{
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/appointments/updateAppointment/${updatedAppointment._id}`, {
                method: "PUT",
                data: updatedAppointment
            });
        ...
        children: [
            ...
            isModalOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                children: !editingAppointment ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$appointments$2f$AppointmentModel$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    ...
                    lineNumber: 102,
                    columnNumber: 13
                }, ("TURBOPACK compile-time value", void 0)) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$appointments$2f$AppointmentUpdateModel$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    onClose: ()=>setIsModalOpen(false),
...
//# sourceMappingURL=app_17b28ee3._.js.map