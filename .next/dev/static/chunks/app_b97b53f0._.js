...
const PurchaseModal = ({ onClose })=>{
    ...
    const [suppliersList, setSuppliersList] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]); // <-- suppliers list
    const [purchaseDate, setPurchaseDate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "PurchaseModal.useState": ()=>new Date().toISOString().slice(0, 10)
    ...
    const [purchaseStatus, setPurchaseStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("Draft");
        ...
        "PurchaseModal.useEffect": ()=>{
            const fetchProducts = {
                "PurchaseModal.useEffect.fetchProducts": async ()=>{
                    try {
                        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/products/ProductName", {
                            method: "GET"
                        });
                        const products = res?.data || res;
                        if (!Array.isArray(products)) throw new Error("Invalid product response");
                        // Map to {id, name} and remove duplicates by name
                        const distinctProducts = Array.from(new Map(products.map({
                            "PurchaseModal.useEffect.fetchProducts.distinctProducts": (p)=>[
                                    p.name,
                                    {
                                        id: p._id,
                                        name: p.name
                        ...
                        }["PurchaseModal.useEffect.fetchProducts.distinctProducts"])).values());
        ...
        "PurchaseModal.useEffect": ()=>{
            const fetchSuppliers = {
                "PurchaseModal.useEffect.fetchSuppliers": async ()=>{
                    try {
                        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/suppliers", {
                            method: "GET"
                        });
                        const data = res?.data || res;
                        if (!Array.isArray(data)) throw new Error("Invalid supplier response");
                        setSuppliersList(data.map({
                            "PurchaseModal.useEffect.fetchSuppliers": (s)=>s.name
                        }["PurchaseModal.useEffect.fetchSuppliers"])); // only names
                    } catch (err) {
                        console.error(err);
                        setErrorModal({
                            show: true,
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/purchases/createPurchase", {
                method: "POST",
                data: payload
            });
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                        ...
                                                        children: [
                                                            ...
                                                            productsList.map((p)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                    value: p.id,
                                                                    children: p.name
                                                                }, p.id, false, {
                                                                    fileName: "[project]/app/components/purchases/PurchasesModal.jsx",
                                ...
                                paymentStatus === "Partial" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "space-y-2",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                            className: "text-sm font-medium",
                                        ...
                                        errors.partialAmount && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-xs text-red-600",
...
_s(PurchaseModal, "dm1LJCYGzIUTWc5L/kFhBgIoHtM=");
_c = PurchaseModal;
...
const PartialPaymentModal = ({ onClose, onUpdate })=>{
    ...
    const [outstandingAmount, setOutstandingAmount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    /* ================= Fetch Purchases ================= */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PartialPaymentModal.useEffect": ()=>{
            const fetchPurchases = {
                "PartialPaymentModal.useEffect.fetchPurchases": async ()=>{
                    try {
                        ...
                        const uniqueSuppliers = Array.from(new Set(all.map({
                            "PartialPaymentModal.useEffect.fetchPurchases.uniqueSuppliers": (p)=>p.supplier
                        }["PartialPaymentModal.useEffect.fetchPurchases.uniqueSuppliers"])));
            ...
            }["PartialPaymentModal.useEffect.fetchPurchases"];
            fetchPurchases();
        }
    }["PartialPaymentModal.useEffect"], []);
    ...
    /* ================= Auto Balance & Status (UI only) ================= */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PartialPaymentModal.useEffect": ()=>{
    ...
    /* ================= Submit ================= */ const handleSubmit = async ()=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$authservice$2f$api$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/purchases/supplierPayment/${encodeURIComponent(selectedSupplier)}`, {
                method: "PUT",
                data: {
                    paidAmount: payment
                }
...
_s(PartialPaymentModal, "gpTKKP1+89LtKvsCiGmlCUD35yA=");
...
//# sourceMappingURL=app_b97b53f0._.js.map