...
"[project]/app/components/Dashboard/Card.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        const fetchData = async ()=>{
            try {
                ...
                const [salesRes, apptRes, testsRes, expenseRes, productRes, purchaseRes] = await Promise.all([
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$authservice$2f$api$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/sales"),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$authservice$2f$api$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/appointments"),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$authservice$2f$api$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/tests"),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$authservice$2f$api$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/expenses"),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$authservice$2f$api$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/products"),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$authservice$2f$api$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])("/purchases")
                ]);
                ...
                // ---------- TODAY ----------
                const todaysAppointments = appointments.filter((a)=>new Date(a.date).toDateString() === today.toDateString());
                const todaysRevenue = sales.filter((s)=>new Date(s.createdAt) >= today).reduce((sum, s)=>sum + Number(s.profit || 0), 0) + todaysAppointments.reduce((sum, a)=>sum + Number(a.paidfee || 0), 0) + tests.filter((t)=>new Date(t.createdAt) >= today).reduce((sum, t)=>sum + Number(t.totalfee || 0), 0);
                // ---------- MONTHLY ----------
                const monthlySalesProfit = sales.filter((s)=>new Date(s.createdAt) >= last30Days).reduce((sum, s)=>sum + Number(s.profit || 0), 0);
                const monthlyPaidSales = sales.filter((s)=>new Date(s.createdAt) >= last30Days).reduce((sum, s)=>sum + Number(s.paidAmount || 0), 0);
                const monthlyAppointments = appointments.filter((a)=>new Date(a.date) >= last30Days).reduce((sum, a)=>sum + Number(a.paidfee || 0), 0);
                const monthlyTests = tests.filter((t)=>new Date(t.createdAt) >= last30Days).reduce((sum, t)=>sum + Number(t.totalfee || 0), 0);
                // ---------- EXPENSE CALCULATIONS ----------
                const totalExpenses = expenses.reduce((sum, e)=>sum + Number(e.amount || 0), 0);
                const pendingPayments = expenses.filter((e)=>e.paymentStatus === "Pending").reduce((sum, e)=>sum + Number(e.amount || 0), 0);
                const completedPayments = expenses.filter((e)=>e.paymentStatus === "Completed").reduce((sum, e)=>sum + Number(e.amount || 0), 0);
                ...
                const totalProductPurchase = purchases.reduce((sum, p)=>sum + Number(p.totalAmount || 0), 0);
                // ---------- SET DASHBOARD CARDS ----------
                setCards([
                    {
...
"[project]/app/components/Dashboard/RevenueTrend.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/components/Dashboard/AppointmentsStatus.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__83a5572a._.js.map